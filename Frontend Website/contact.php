    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    <a class="navbar-brand" href="Main Website.html">
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="Main Website.html">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row contact-block">
                    ...
                    <div class="col-md-7 contact-right mt-md-0 mt-4">
                        <form method="post" class="signin-form">
                            ...
                            <button class="btn btn-style btn-style-primary-2" name="btn_submit">Send Message</button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php
    ...
    if(isset($_POST["btn_submit"]))
    {
        ...
        $insert=mysqli_query($connect,"insert into contact(Name,Email,Subject,URL,Message) values('$name','$email','$subject','$url','$message')") or die(mysqli_error($connect));
        if($insert)
        {
        ...
        {
            echo "window.alert('Data insertion failed');";
        }
    }
?>