...
<!--logo start-->
<div class="brand">
    <a href="admin_website.php" class="logo">
        VISITORS
    </a>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Aaryan Thakur</span>
                <b class="caret"></b>
            </a>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="admin_website.php">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 Visitors. All rights reserved | Design by <a href="http://www.sumagoinfotech.com">W3layouts</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
