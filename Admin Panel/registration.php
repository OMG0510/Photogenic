...
<?php
	...
	if(isset($_POST["register"]))
    {
        ...
        $insert1=mysqli_query($connect,"insert into registrations(name,email,phone,password) values('$name','$email','$phone','$password')") or die(mysqli_error($connect));
        if($insert1)
        {
            echo "window.alert('Registration successfull...');";
        }
        else
        {
